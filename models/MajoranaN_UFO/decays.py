...
Decay_P__tilde__FS = Decay(name = 'Decay_P__tilde__FS',
                           particle = P.P__tilde__FS,
                           partial_widths = {(P.W__plus__,P.e__minus__):'((mm**2 - MW**2)*(f1**2*mm**2 + (f1**2*mm**4)/MW**2 - 2*f1**2*MW**2))/(32.*cmath.pi*abs(mm)**3)',
                                             (P.W__plus__,P.mu__minus__):'((mm**2 - MW**2)*(f2**2*mm**2 + (f2**2*mm**4)/MW**2 - 2*f2**2*MW**2))/(32.*cmath.pi*abs(mm)**3)',
                                             (P.Z,P.vm):'((mm**2 - MZ**2)*(f3**2*mm**2 + (f3**2*mm**4)/MZ**2 - 2*f3**2*MZ**2))/(32.*cmath.pi*abs(mm)**3)',
                                             (P.W__minus__,P.e__plus__):'((mm**2 - MW**2)*(f1**2*mm**2 + (f1**2*mm**4)/MW**2 - 2*f1**2*MW**2))/(32.*cmath.pi*abs(mm)**3)',
                                             (P.W__minus__,P.mu__plus__):'((mm**2 - MW**2)*(f2**2*mm**2 + (f2**2*mm**4)/MW**2 - 2*f2**2*MW**2))/(32.*cmath.pi*abs(mm)**3)',
                                             (P.Z,P.vm__tilde__):'((mm**2 - MZ**2)*(f3**2*mm**2 + (f3**2*mm**4)/MZ**2 - 2*f3**2*MZ**2))/(32.*cmath.pi*abs(mm)**3)'})
...
Decay_W__plus__ = Decay(name = 'Decay_W__plus__',
                        ...
                        partial_widths = {(P.c,P.s__tilde__):'(ee**2*MW**4)/(16.*cmath.pi*sw**2*abs(MW)**3)',
                                          (P.P__tilde__FS,P.e__plus__):'((-mm**2 + MW**2)*(-(f1**2*mm**2) - (f1**2*mm**4)/MW**2 + 2*f1**2*MW**2))/(48.*cmath.pi*abs(MW)**3)',
                                          (P.P__tilde__FS,P.mu__plus__):'((-mm**2 + MW**2)*(-(f2**2*mm**2) - (f2**2*mm**4)/MW**2 + 2*f2**2*MW**2))/(48.*cmath.pi*abs(MW)**3)',
...
Decay_Z = Decay(name = 'Decay_Z',
                ...
                partial_widths = {(P.b,P.b__tilde__):'((-7*ee**2*MB**2 + ee**2*MZ**2 - (3*cw**2*ee**2*MB**2)/(2.*sw**2) + (3*cw**2*ee**2*MZ**2)/(2.*sw**2) - (17*ee**2*MB**2*sw**2)/(6.*cw**2) + (5*ee**2*MZ**2*sw**2)/(6.*cw**2))*cmath.sqrt(-4*MB**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)',
                                  ...
                                  (P.P__tilde__FS,P.P__tilde__FS):'((-64*f5**2*mm**2 + 16*f5**2*MZ**2)*cmath.sqrt(-4*mm**2*MZ**2 + MZ**4))/(96.*cmath.pi*abs(MZ)**3)',
                                  (P.P__tilde__FS,P.vm__tilde__):'((-mm**2 + MZ**2)*(-(f3**2*mm**2) - (f3**2*mm**4)/MZ**2 + 2*f3**2*MZ**2))/(48.*cmath.pi*abs(MZ)**3)',
                                  ...
                                  (P.vm,P.P__tilde__FS):'((-mm**2 + MZ**2)*(-(f3**2*mm**2) - (f3**2*mm**4)/MZ**2 + 2*f3**2*MZ**2))/(48.*cmath.pi*abs(MZ)**3)',
