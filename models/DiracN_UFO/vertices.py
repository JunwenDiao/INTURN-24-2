...
V_43 = Vertex(name = 'V_43',
              ...
              color = [ '1' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_74,(0,1):C.GC_74})
...
V_45 = Vertex(name = 'V_45',
              ...
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFS1, L.FFS3 ],
              couplings = {(0,0):C.GC_70,(0,1):C.GC_68})
...
V_69 = Vertex(name = 'V_69',
              particles = [ P.FS__tilde__, P.FS, P.Z ],
              color = [ '1' ],
              lorentz = [ L.FFV1, L.FFV2 ],
              couplings = {(0,1):C.GC_14,(0,0):C.GC_13})
...
V_82 = Vertex(name = 'V_82',
              particles = [ P.e__plus__, P.FS, P.W__minus__ ],
              color = [ '1' ],
              lorentz = [ L.FFV3 ],
              couplings = {(0,0):C.GC_10})

V_83 = Vertex(name = 'V_83',
              particles = [ P.mu__plus__, P.FS, P.W__minus__ ],
              color = [ '1' ],
              lorentz = [ L.FFV3 ],
              couplings = {(0,0):C.GC_11})

V_84 = Vertex(name = 'V_84',
              particles = [ P.FS__tilde__, P.e__minus__, P.W__plus__ ],
              color = [ '1' ],
              lorentz = [ L.FFV3 ],
              couplings = {(0,0):C.GC_10})

V_85 = Vertex(name = 'V_85',
              particles = [ P.FS__tilde__, P.mu__minus__, P.W__plus__ ],
              color = [ '1' ],
              lorentz = [ L.FFV3 ],
              couplings = {(0,0):C.GC_11})

V_86 = Vertex(name = 'V_86',
              particles = [ P.vm__tilde__, P.FS, P.Z ],
              color = [ '1' ],
              lorentz = [ L.FFV3 ],
              couplings = {(0,0):C.GC_12})

V_87 = Vertex(name = 'V_87',
              particles = [ P.FS__tilde__, P.vm, P.Z ],
              color = [ '1' ],
              lorentz = [ L.FFV3 ],
              couplings = {(0,0):C.GC_12})
